...
# Doc §5.2: a 60–120 s interval is ample; ingestion is incremental (only new
# submissions are pulled each run), so 60 s keeps the board fresh without
# hammering the CF API.
POLL_MINUTES = 1
RUN_TIMEOUT_SECONDS = 3 * 60  # kill if a single run exceeds this
